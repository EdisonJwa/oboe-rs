...
pub type std___ndk1_string = [u32; 3usize];
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std___ndk1_allocator {
    pub _address: u8,
}
pub type std___ndk1_allocator_size_type = u32;
pub type std___ndk1_allocator_difference_type = u32;
pub type std___ndk1_allocator_value_type = u8;
pub type std___ndk1_allocator_propagate_on_container_move_assignment = u8;
pub type std___ndk1_allocator_is_always_equal = u8;
pub type std___ndk1_allocator_pointer = u8;
pub type std___ndk1_allocator_const_pointer = u8;
pub type std___ndk1_allocator_reference = u8;
pub type std___ndk1_allocator_const_reference = u8;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std___ndk1_allocator_rebind {
    pub _address: u8,
}
pub type std___ndk1_allocator_rebind_other = u8;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std___ndk1_vector {
    pub _address: u8,
}
pub type std___ndk1_vector___default_allocator_type = u8;
pub type std___ndk1_vector___self = u8;
pub type std___ndk1_vector_value_type = u8;
pub type std___ndk1_vector_allocator_type = u8;
pub type std___ndk1_vector___alloc_traits = u8;
pub type std___ndk1_vector_reference = u8;
pub type std___ndk1_vector_const_reference = u8;
pub type std___ndk1_vector_size_type = u8;
pub type std___ndk1_vector_difference_type = u8;
pub type std___ndk1_vector_pointer = u8;
pub type std___ndk1_vector_const_pointer = u8;
pub type std___ndk1_vector_iterator = u8;
pub type std___ndk1_vector_const_iterator = u8;
pub type std___ndk1_vector_reverse_iterator = u8;
pub type std___ndk1_vector_const_reverse_iterator = u8;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std___ndk1_vector___destroy_vector {
    pub _address: u8,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std___ndk1_vector__ConstructTransaction {
    pub _address: u8,
}
...
#[doc = " This format is used for audio compressed in MP3 format."]
pub const oboe_AudioFormat_MP3: oboe_AudioFormat = 6;
#[doc = " This format is used for audio compressed in AAC LC format."]
pub const oboe_AudioFormat_AAC_LC: oboe_AudioFormat = 7;
#[doc = " This format is used for audio compressed in AAC HE V1 format."]
pub const oboe_AudioFormat_AAC_HE_V1: oboe_AudioFormat = 8;
#[doc = " This format is used for audio compressed in AAC HE V2 format."]
pub const oboe_AudioFormat_AAC_HE_V2: oboe_AudioFormat = 9;
#[doc = " This format is used for audio compressed in AAC ELD format."]
pub const oboe_AudioFormat_AAC_ELD: oboe_AudioFormat = 10;
#[doc = " This format is used for audio compressed in AAC XHE format."]
pub const oboe_AudioFormat_AAC_XHE: oboe_AudioFormat = 11;
#[doc = " This format is used for audio compressed in OPUS."]
pub const oboe_AudioFormat_OPUS: oboe_AudioFormat = 12;
...
#[repr(C)]
pub struct oboe_AudioStreamPresentationCallback__bindgen_vtable(::std::os::raw::c_void);
#[doc = " AudioStreamPresentationCallback defines a callback interface for\n being notified when a data presentation event is filed.\n\n It is used with AudioStreamBuilder::setPresentationCallback()."]
#[repr(C)]
#[derive(Debug)]
pub struct oboe_AudioStreamPresentationCallback {
    pub vtable_: *const oboe_AudioStreamPresentationCallback__bindgen_vtable,
}
#[test]
fn bindgen_test_layout_oboe_AudioStreamPresentationCallback() {
    assert_eq!(
        ::std::mem::size_of::<oboe_AudioStreamPresentationCallback>(),
        4usize,
        concat!(
            "Size of: ",
            stringify!(oboe_AudioStreamPresentationCallback)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<oboe_AudioStreamPresentationCallback>(),
        4usize,
        concat!(
            "Alignment of ",
            stringify!(oboe_AudioStreamPresentationCallback)
...
pub struct oboe_AudioStreamBase {
    ...
    #[doc = " The partial data callback which will be fired when new data is ready to be read/written."]
    pub mPartialDataCallback: *mut oboe_AudioStreamPartialDataCallback,
    pub mSharedPartialDataCallback: [u32; 2usize],
    ...
    pub mSharedPresentationCallback: [u32; 2usize],
...
fn bindgen_test_layout_oboe_AudioStreamBase() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mPartialDataCallback) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStreamBase),
            "::",
            stringify!(mPartialDataCallback)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mSharedPartialDataCallback) as usize - ptr as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStreamBase),
            "::",
            stringify!(mSharedPartialDataCallback)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mSharedPresentationCallback) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStreamBase),
            "::",
            stringify!(mSharedPresentationCallback)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mDeviceIds) as usize - ptr as usize },
        164usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStreamBase),
            "::",
            stringify!(mDeviceIds)
        )
    );
}
extern "C" {
...
pub struct oboe_AudioStreamBuilder {
    pub _bindgen_opaque_blob: [u32; 45usize],
}
#[test]
...
extern "C" {
    #[link_name = "\u{1}_ZN4oboe11AudioStreamD1Ev"]
    pub fn oboe_AudioStream_AudioStream_destructor(this: *mut oboe_AudioStream);
}
extern "C" {
...
extern "C" {
    #[doc = " Override this to provide your own behaviour for the parital audio callback\n\n @param audioData container array which audio frames will be written into or read from\n @param numFrames number of frames which were read/written\n @return the actual processed frames"]
    #[link_name = "\u{1}_ZN4oboe11AudioStream23firePartialDataCallbackEPvi"]
    pub fn oboe_AudioStream_firePartialDataCallback(
        this: *mut ::std::os::raw::c_void,
        audioData: *mut ::std::os::raw::c_void,
        numFrames: ::std::os::raw::c_int,
    ) -> i32;
...
pub const oboe_AudioStream_kMaxDelayBeforeCloseMillis: ::std::os::raw::c_int = 100;
...
pub const oboe_Version_Minor: u8 = 10;
...
pub const oboe_Version_Text: &[u8; 7] = b"1.10.0\0";
...
pub const oboe_Version_Number: u32 = 17432576;
#[test]
